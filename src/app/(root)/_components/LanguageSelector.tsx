...
function LanguageSelector() {
  ...
  const handleLanguageSelect = (langId: string) => {
    const isLocked = !hasProAccess && !FREE_LANGUAGES.includes(langId);
    if (isLocked) return;
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        <ChevronDownIcon
          className={`size-4 text-gray-400 transition-all duration-300 ${isOpen ? "rotate-180" : ""}`}
        />
      </motion.button>
          ...
          >
            ...
            <div className="max-h-[280px] overflow-y-auto">
              {Object.values(LANGUAGE_CONFIG).map((lang, index) => {
                const isLocked = !hasProAccess && !FREE_LANGUAGES.includes(lang.id);
                ...
                return (
                  ...
                  >
                    <button
                      ...
                      disabled={isLocked}
                    >
                      <div className="size-8 bg-gray-800/50 rounded-lg p-1.5">
                        <Image
                          src={lang.logoPath}
                          alt={lang.label}
                          width={24}
