...
import { Blocks, Code2, Share2, Sparkles } from "lucide-react";
...
function NavigationHeader({ onShareClick }: NavigationHeaderProps) {
  return (
        ...
        <div className="relative h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-lg overflow-hidden bg-gradient-to-r from-blue-500 to-blue-600 opacity-90 hover:opacity-100 transition-opacity text-white"
              type="button"
            >
